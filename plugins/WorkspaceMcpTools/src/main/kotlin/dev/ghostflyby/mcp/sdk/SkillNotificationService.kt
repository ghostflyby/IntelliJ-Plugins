...
internal const val BUNDLED_SKILL_RELATIVE_PATH: String = "agent-skills/workspace-agent-bridge"
internal const val SKILL_ONLINE_URL: String =
    "https://github.com/ghostflyby/IntelliJ-Plugins/tree/main/.agents/skills/workspace-agent-bridge"
...
internal fun bundledSkillPath(): Path? {
    return PluginPathManager.getPluginResource(SkillNotificationActivity::class.java, BUNDLED_SKILL_RELATIVE_PATH)
        ?.toPath()
}

...
## 未实现/部分实现文档（含待办建议）
- `notes/SearchScopePhase1Notes.md`（含 future work）
- `notes/SymbolSearchPhase1Notes.md`（含候选快捷入口待实现）
- `notes/CodeQualityToolsetPhase2Notes.md`（含候选快捷入口待实现）
- `first-call/AgentFirstCallShortcutDeltas.md`（含阶段性新增建议，持续跟踪）

...
2. Add a dedicated `externalSystemViewContributor` for a usable Mill tool window structure with executable task nodes.
3. Keep Scala SDK and external library import stable across common Scala Mill layouts.

Archived notes:
`plugins/Mill/docs/Mill-ToolWindowTasks.md`

...
public data class ParsedWorkspaceUrl(
    public val instanceKey: String,
    public val pathAndQuery: String,
)

public fun parseWorkspaceUrl(uri: String): ParsedWorkspaceUrl? {
...
public data class ResourceClassInfo(
    public val pathSegments: List<PathSegmentInfo>,
    public val queryParams: List<QueryParamInfo>,
    public val tailParamName: String?,
    public val parentName: String?,
) {
    public val pathParamNames: Set<String> = pathSegments.mapNotNull { it.paramName }.toSet()

    public companion object {
        private val PARAM_NAME_RE = Regex("^[a-zA-Z_][a-zA-Z0-9_]*$")

        public fun from(descriptor: SerialDescriptor): ResourceClassInfo {
...
public data class PathSegmentInfo(
    public val text: String,
    public val name: String,
    public val isParameter: Boolean,
    public val paramName: String?,
    public val isTail: Boolean,
)

public data class QueryParamInfo(
    public val name: String,
    public val isOptional: Boolean,
)

public class WorkspaceResourceUriFormat : StringFormat {
    ...
    public fun templateUri(descriptor: SerialDescriptor): String {
    ...
    private class UrlParsingDecoder(
        ...
        override fun decodeStringElement(descriptor: SerialDescriptor, index: Int): String =
            params[descriptor.getElementName(index)] ?: ""

        override fun decodeIntElement(descriptor: SerialDescriptor, index: Int): Int =
            decodeStringElement(descriptor, index).toIntOrNull() ?: 0
        ...
        override fun decodeByteElement(descriptor: SerialDescriptor, index: Int): Byte =
            decodeStringElement(descriptor, index).toByteOrNull() ?: 0

        override fun decodeShortElement(descriptor: SerialDescriptor, index: Int): Short =
            decodeStringElement(descriptor, index).toShortOrNull() ?: 0

        override fun decodeLongElement(descriptor: SerialDescriptor, index: Int): Long =
            decodeStringElement(descriptor, index).toLongOrNull() ?: 0L

        override fun decodeFloatElement(descriptor: SerialDescriptor, index: Int): Float =
            decodeStringElement(descriptor, index).toFloatOrNull() ?: 0f

        override fun decodeDoubleElement(descriptor: SerialDescriptor, index: Int): Double =
            decodeStringElement(descriptor, index).toDoubleOrNull() ?: 0.0

        override fun decodeCharElement(descriptor: SerialDescriptor, index: Int): Char =
            decodeStringElement(descriptor, index).firstOrNull() ?: '\u0000'

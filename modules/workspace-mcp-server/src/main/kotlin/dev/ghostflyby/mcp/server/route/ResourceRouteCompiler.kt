...
public object ResourceRouteCompiler {
    public fun compile(registrations: Collection<WorkspaceResourceRouteContribution>): ResourceRouteSnapshot {
...
public fun ResourceClassInfo.templateUri(): String {
    return "ij-workspace://{instanceKey}/${pathTemplate()}${queryTemplate()}"
}

public fun ResourceClassInfo.pathTemplate(): String {
...
public fun ResourceClassInfo.queryTemplate(): String {
    return if (queryParams.isNotEmpty()) {
        "{?${queryParams.joinToString(",") { it.name }}}"
    } else ""
}

public data class WorkspaceResourceRouteContribution(
    public val featureName: String,
    public val roots: List<ResourceSegment>,

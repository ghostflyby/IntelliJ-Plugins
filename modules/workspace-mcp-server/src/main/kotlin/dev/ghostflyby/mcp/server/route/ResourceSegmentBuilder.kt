 ...
 */
public open class ResourceSegmentCollector {
    ...
    public val roots: List<ResourceSegment> get() = resourceSegments.toList()
    public val resourceListRoutes: List<ResourceListRoute> get() = listRoutes.toList()
    public val templateListRoutes: List<ResourceTemplateListRoute> get() = resourceTemplateListRoutes.toList()

    public fun addReadRoute(
    ...
    public fun addResourceListRoute(
        serializer: KSerializer<*>,
    ...
    public fun addTemplateListRoute(
        serializer: KSerializer<*>,
...
public inline fun <reified T : Any> ResourceSegmentCollector.read(
...
public inline fun <reified T : Any> ResourceSegmentCollector.listResources(
...
public inline fun <reified T : Any> ResourceSegmentCollector.listTemplates(
...
public fun buildReadTreeFromResourceClass(

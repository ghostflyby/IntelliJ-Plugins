...
import dev.ghostflyby.mcp.server.route.ReadRouteDefault
 ...
 * flat list providers.
 */
public class WorkspaceMcpResourceCatalog(
    ...
    public fun updateSnapshot(snapshot: ResourceRouteSnapshot) {
        snapshotRef.set(snapshot)
    }

    public suspend fun listResources(connection: ClientConnection, request: ListResourcesRequest): ListResourcesResult {
    ...
    public suspend fun listTemplates(

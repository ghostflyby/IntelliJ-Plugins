...
public class WorkspaceMcpInvalidationBus(
    ...
    public val resourceUpdateBatches: StateFlow<Set<String>> = _resourceUpdates.asStateFlow()
    public val listChangedBatches: StateFlow<Set<ListChangedEvent>> = _listChanged.asStateFlow()
    ...
    public fun registerResourceUpdates(flow: StateFlow<ResourceUpdateState>) {
        scope.launch {
    ...
    public fun registerSessionListChanged(kind: ListChangeKind, flow: StateFlow<PerSessionListChange>) {
        scope.launch {
